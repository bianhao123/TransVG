...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_root', type=str, default='/cto_studio/datastory/phrase_grounding/dataset',
